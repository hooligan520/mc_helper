...
public class LookAtInfoOverlay {
    ...
    // ==================== 方块信息渲染 ====================
    private static void renderBlockInfo(GuiGraphicsExtractor guiGraphics, Minecraft mc,
        ...
        // 方块名称（大标题，带图标）
        guiGraphics.text(mc.font, "\u00A7f\u25A0 " + blockName, textX, textY, TEXT_WHITE, true);
        textY += LINE_HEIGHT;

        // 方块 ID（小字灰色）
        guiGraphics.text(mc.font, "\u00A78" + blockId, textX + 8, textY, TEXT_DARK, true);
        textY += LINE_HEIGHT;
        ...
        // 坐标
        guiGraphics.text(mc.font, "\u00A77\u2316 坐标: \u00A7f" + coordText,
    ...
    // ==================== 实体信息渲染 ====================
    private static void renderEntityInfo(GuiGraphicsExtractor guiGraphics, Minecraft mc,
        ...
        // 实体名称
        guiGraphics.text(mc.font, "\u00A7f\u25CF " + entityName, textX, textY, TEXT_WHITE, true);
        textY += LINE_HEIGHT;

        // 实体 ID
        guiGraphics.text(mc.font, "\u00A78" + entityId, textX + 8, textY, TEXT_DARK, true);
        textY += LINE_HEIGHT;
        ...
        // 类型标签
        guiGraphics.text(mc.font, typeLabel, textX, textY, typeColor, true);
        textY += LINE_HEIGHT;
