...
public class EquipmentHudOverlay {
    ...
    public static final ForgeLayer LAYER = (guiGraphics, deltaTracker) -> {
        ...
        // 标题
        guiGraphics.text(mc.font, "\u00A7b\u2726 装备耐久", textX, textY, TEXT_WHITE, true);
        textY += titleHeight;
     ...
     * 渲染单行装备信息
     */
    private static void renderEquipmentRow(GuiGraphicsExtractor guiGraphics, Minecraft mc,
        ...
        guiGraphics.text(mc.font, durText, textOffsetX, y + 1, TEXT_WHITE, true);
